                    ...
                    <div className="max-w-[1120px] w-full flex lg:flex-row flex-col lg:gap-22 gap-8">
                        ...
                        <div className="max-w-[306px] w-full">
                            ...
                            <ul className="list-disc pl-5">
                                ...
                                <li className="font-semibold text-[16px] mb-2">Information We Collect</li>
                                <li className="font-semibold text-[16px] mb-2">How We Use Your Information</li>
                                <li className="font-semibold text-[16px] mb-2">Data Sharing and Security</li>
                                <li className="font-semibold text-[16px] mb-2">Your choices and Rights</li>
                                <li className="font-semibold text-[16px] mb-2">Policy Updates</li>
                        ...
                        <div>
                            ...
                            <div className="mb-6">
                                ...
                                <p className="font-normal text-[16px] mb-4 text-[#475467] ">Transactional Data: Details of financial records, transfers, and reconciliation transactions.</p>

                                <p className="font-normal text-[16px] mb-4 text-[#475467] ">Personal Information: Such as account details, names, email addresses, and phone numbers provided during registration or service use</p>

                                <p className="font-normal text-[16px] mb-4 text-[#475467] ">Usage Data: Log files, device information, and analytics that help us understand how you interact with our platform.</p>

                                <p className="font-normal text-[16px] text-[#475467] ">Other Data: Additional information you provide or that is automatically collected to enhance your experience.</p>
                            </div>
                            ...
                            <div className="mb-6">
                                ...
                                <p className="font-normal text-[16px] text-[#475467] ">We implement industry-standard security measures to protect your data from unauthorized access, disclosure, or misuse. While we strive for maximum security, please be aware that no system is completely foolproof.</p>
                            </div>
                            ...
                            <div className="mb-6">
                                ...
                                <p className="font-normal text-[16px] text-[#475467] ">For more information about our terms and conditions, please visit our Terms and Conditions page.</p>
                            </div>
                        </div>
                    </div>
