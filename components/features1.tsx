...
export default function Features1() {
  return (
    <main className="flex flex-col items-center gap-[96px] self-stretch py-[96px] px-0 bg-white 
">
      <div className="flex w-[1280px] items-center gap-[96px] px-[32px] py-0">
        ...
        <div className="flex  h-[512px] justify-end items-center flex-[1_0_0]">
          <div
            className="flex h-[512px] justify-center items-center rounded-[10px]  "
          >
            {/* <div
              className="w-[712px] h-[512px] flex-shrink-0 bg-[#101828] shadow-[0px_32px_64px_-12px_rgba(16,24,40,0.14)]"
            ></div> */}
