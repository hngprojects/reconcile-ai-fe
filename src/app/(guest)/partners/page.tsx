      ...
      <div>
              ...
              <div className="relative w-full max-w-[536px] flex justify-center items-center">
                <picture>
                  <source
                    ...
                    srcSet="/assets/images/Business_people.svg"
                  />
                  <img
          ...
          <div className="flex flex-col p-4 w-full">
            <div className="flex justify-center flex-col md:flex-row gap-4 md:gap-6 lg:gap-[38px] w-full">
              {[
                ...
                <div
                  key={i}
                  className="border border-[#D9D9D9] rounded-[8px] p-4 md:p-6 flex flex-col justify-center gap-3
            ...
            <div className="flex justify-center flex-col md:flex-row gap-4 md:gap-6 lg:gap-[38px] mt-7 lg:mt-11 w-full">
              {["Market Reach", "Dedicated Support"].map((title, i) => (
                <div
                  key={i}
                  className="border w-full md:w-[270px] lg:w-[404px] border-[#D9D9D9] rounded-[8px] p-4 md:p-6 flex flex-col justify-center gap-3"
                >
        ...
        <div className="bg-gray-50 sm:bg-white pb-25">
          <Container className="py-8">
            {/* Outer wrapper (replacing the old “my-10 border ... max-w-7xl text-center” etc.) */}
            <div className="flex flex-col gap-11 bg-[#FBFEFD] py-7 text-center items-center sm:rounded-xl">
