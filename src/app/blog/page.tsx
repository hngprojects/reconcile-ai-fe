      ...
      <div className="">
        <div className="">
          <p className="flex justify-center items-center">
            <Link href="/" className="text-[#5C5C5C] text-[18px] font-[400] leading-[20px]">HOME / BLOG</Link>
          </p>
        </div>
        {/* Blog Header */}
        <div className="text-center mb-12 mx-auto flex flex-col justify-center items-center">
          <h1 className="text-center max-w-[672px] text-[36px] md:text-[48px] font-[600] leading-[140%] my-4 mx-auto">Stay Ahead with AI-Powered Financial Insights</h1>
        ...
        <div className="md:px-[100px] px-4 mb-[24px] lg:mb-[100px] md:mb-[50px]">
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className={`cursor-pointer px-4 py-2 flex items-center justify-center ${currentPage === 1 ? 'text-[#5C5C5C] cursor-not-allowed' : 'text-[#2A5743] hover:underline'}`}
              aria-label="Previous page"
            >
              {isMobile ? (
                <Image
                className="text-[#5C5C5C]"
                src="/assets/images/icon-pagination.svg"
                alt=""
                width={11.67}
                height={11.67}
              />
            ...
            <button
              ...
              className={`cursor-pointer px-4 py-2 flex items-center justify-center ${currentPage === totalPages ? 'text-[#5C5C5C] cursor-not-allowed  ' : 'text-[#2A5743] hover:underline'}`}
              aria-label="Next page"
            >
              {isMobile ? (
                 <Image
                 className="text-[#5C5C5C]"
                 src="/assets/images/icon-pagination2.svg"
                 alt=""
                 width={10}
                 height={10}
               />
                ...
                height={11.67}
              />
                <span className="text-[14px] font-[500] text-[#5C5C5C]">Next</span>
                </div>
              )}
            </button>
          </div>
