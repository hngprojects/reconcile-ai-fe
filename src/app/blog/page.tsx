  ...
  return (
   <div>
     <div className="pt-[100px] max-w-7xl mx-auto">
      ...
      <hr className="md:px-[80px] max-w-[calc(100%-160px)] flex mx-auto" />
      ...
      {totalPages > 1 && (
        <div className="md:px-[100px] py-10">
          <div className="flex items-center justify-between">
            <button
              onClick={() => paginate(currentPage > 1 ? currentPage - 1 : 1)}
              disabled={currentPage === 1}
              className={`px-4 py-2 text-[14px] cursor-pointer font-[500] ${
                currentPage === 1
            ...
            <button
              ...
              className={`px-4 py-2 text-[14px] font-[500] ${
