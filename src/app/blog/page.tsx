...
export default function BlogPage() {
  ...
  return (
    <div className="py-[100px] ">
      ...
      {/* Blog List Heading */}
      <div className="px-4 md:px-[80px] pt-[45px]">
        <div className="mb-8">
                ...
                <div className="flex flex-col px-4">
                  <div className="py-[24px]">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <Image 
                        src="/assets/images/blog-img/icon-blog.svg"
                        alt=""
                        width={10} 
                        height={10} 
                      />
        ...
        <div className="px-[100px]">
          <div className="flex items-center justify-between">
            <button 
              ...
              className={`px-4 py-2 text-[14px] cursor-pointer font-[500] ${currentPage === 1 ? 'text-[#5C5C5C] cursor-not-allowed' : 'text-[#2A5743] hover:underline'}`}
            >
              Previous
            </button>
            ...
            <button 
              ...
              className={`px-4 py-2 text-[14px] font-[500] ${currentPage === totalPages ? 'text-gray-400 cursor-not-allowed' : 'text-[#2A5743] hover:underline'}`}
            >
              Next
            </button>
          </div>
