  ...
  return (
    <main className="min-h-screen flex flex-col items-center">
      ...
      <div className="flex-1 w-full max-w-3xl px-4 py-[59px] flex flex-col items-center text-center">
        ...
        <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-8">Automate Your Financial Reconciliation</h2>

        <p className="text-lg text-[#333333] mb-12 max-w-2xl">
          Experience the power of Ai-driven financial reconciliation. Fill out the form below to get a free personalized
          Demo of ReconXi.
        </p>
