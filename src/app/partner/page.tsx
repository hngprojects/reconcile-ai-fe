        ...
        <main className="min-h-screen flex flex-col ">
            <div className=" flex flex-col items-center">
                ...
                >
                    ...
                    >
                        Thank you for your interest in partnering with ReconXi! Please fill out the form below, and our team will reach out to discuss partnership opportunities.
                    </motion.p>
