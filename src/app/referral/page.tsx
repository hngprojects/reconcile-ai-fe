    ...
    <div className=" ">
      ...
      <section className="px-[50px] py-[33px]">
        <div className="bg-[#2E604A] rounded-br-[100px] rounded-tl-[100px] flex justify-between items-center">
          <div className="flex flex-col justify-between ml-[80px]">
            <h2 className="font-semibold leading-[50px] text-white mb-[24px] text-[40px]">
              Invite and Earn Rewards With ReconXi Referral Program!
            </h2>
            <p className="mb-[32px] font-normal leading-[30px] text-[20px] text-[#F3F3F3]">
      ...
      <section className="px-[50px]">
        <div className="px-[34px]">
          <div></div>
          <h2 className="font-medium leading-[72px] tracking-[-2%] text-[25px] text-[#02542D]">
            How it works
          </h2>
            ...
            <div className="pt-[8px] pl-[16px] border">
              ...
              <div className="flex flex-col">
                <div className="px-[20px] mb-[]">
                  <h3 className="text-[#02542D] leading-[72px] font-medium text-[20px]">
                    Invite Your Friends:
                  </h3>
                  <p className="text-[#2C2C2C] text-[16px] leading-[30px] font-normal">
      ...
      <div className="px-[74px]">
        <div className="flex justify-between items-center">
          <div className="">
            <h2 className="font-medium leading-[72px] tracking-[-2%] text-[30px]">
              Why Join?
            </h2>
            <ul className="list-disc pl-5 space-y-2">
              <li className="font-normal leading-[30px] text-[16px]">
            ...
            <p className="mt-[46px]">
              ...
              <a
                href="#"
                className="text-[#6971FF] font-normal leading-[30px] text-[16px]"
              >
                link
              </a>{" "}
      ...
      <div className="my-16 mx-20">
        <div className="mb-[64px]">
          <h2 className="text-[36px] tracking-[-2%] font-semibold mb-[20px] text-center text-[#101828]">
