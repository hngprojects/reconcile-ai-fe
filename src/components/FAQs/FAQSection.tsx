...
const faqItems: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      'No, uploaded bank statements are only stored temporarily for processing. Once the required data is extracted, the file is automatically deleted from our servers.',
  },
  {
    question: 'Can I manually update matched transactions?',
    answer: 'Yes, you can manually update matched transactions.',
  },
  {
    question:
      ...
      <Container className="py-16">
        <div className="mx-auto w-full max-w-[768px]">
          <div className="flex flex-col gap-[20px] text-center">
            <h1 className="text-3xl font-semibold text-[#101828] sm:text-4xl">
              Frequently Asked Questions
            </h1>
            <p className="text-[#475467] sm:text-xl">
