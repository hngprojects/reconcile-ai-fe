...
import UploadCard from './components/upload-bankStatement/UploadCard'
...
type UploadBankStatementFormValues = z.infer<typeof UploadBankStatementSchema>
...
const UploadBankStatementForm = () => {
  const {
    ...
    watch,
    formState: { errors },
  } = useFormContext<UploadBankStatementFormValues>()
