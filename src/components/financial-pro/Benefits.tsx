...
export default function Benefits() {
  return (
    <section
      className="bg-[#FFFFFF] lg:bg-[#F4F5F6] py-10 px-0 lg:p-[31px]"
      aria-labelledby="benefits-title"
    >
      <Container className="lg:bg-[#FFFFFF] lg:px-25 md:py-10 lg:shadow-md">
        <div
        ...
        >
          <h2
            id="benefits-title"
            className="text-[28px] sm:text-[32px] md:text-[40px] leading-[42px] md:leading-[60px] font-semibold lg:font-medium text-[#101828] text-center tracking-[-0.02em] mb-8 md:mb-12"
          >
            Simplify your bank reconciliation
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-[19px] md:gap-x-12 lg:gap-x-[74px] w-full">
              {benefits.map((benefit, index) => (
                <div
                  key={index}
                  
                  className="bg-white rounded-[8px] px-5 py-[16px] md:py-[30px] border border-[#CBCBCB]"
                  role="listitem"
                >
                  <h3 className="text-[16px] leading-[24px] font-semibold text-[#2E604A] mb-3">
                    {benefit.title}
                  </h3>
                  <p className="text-[14px] font-medium leading-[140%] text-[#3B3E45]">
                    {benefit.description}
                  </p>
                </div>
              ))}
