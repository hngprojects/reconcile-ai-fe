...
// SVG components for cleaner, reusable icons
...
const CostIcon = () => (
  ...
  >
    <path
      d="M5 1H1M1 1V5M1 1L6 6M13 1H17M17 1V5M17 1L12 6M5 17H1M1 17V13M1 17L6 12M13 17H17M17 17V13M17 17L12 12"
      stroke="#2E604A"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const ScaleIcon = () => (
  ...
  >
    <path
      d="M24 0V7.5H22.5V2.56641L13.5 11.5664L9 7.06641L1.08984 14.9648L0.0351562 13.9102L9 4.93359L13.5 9.43359L21.4336 1.5H16.5V0H24Z"
      fill="#2E604A"
    />
  </svg>
)
...
export default function Benefits() {
  return (
    <section
      className="bg-[#FFFFFF] px-0 py-10 lg:bg-[#F4F5F6] lg:p-[31px]"
      aria-labelledby="benefits-title"
    >
      <Container className="md:py-10 lg:bg-[#FFFFFF] lg:px-25 lg:shadow-md">
        <div className="flex flex-col items-center">
          <h2
            id="benefits-title"
            className="mb-8 text-center text-[28px] leading-[42px] font-semibold tracking-[-0.02em] text-[#101828] sm:text-[32px] md:mb-12 md:text-[40px] md:leading-[60px] lg:font-medium"
          >
            Simplify your bank reconciliation
          </h2>

          <div className="grid w-full grid-cols-1 gap-x-6 gap-y-[19px] md:grid-cols-2 md:gap-x-12 lg:gap-x-[74px]">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="rounded-[8px] border border-[#CBCBCB] bg-white px-5 py-[16px] md:py-[30px]"
                role="listitem"
              >
                <h3 className="mb-3 flex items-center gap-[10px] text-[16px] leading-[24px] font-semibold text-[#2E604A]">
                  <benefit.icon /> {benefit.title}
                </h3>
                <p className="text-[14px] leading-[140%] font-medium text-[#3B3E45]">
                  {benefit.description}
                </p>
              </div>
            ))}
