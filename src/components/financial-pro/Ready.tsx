    ...
    >
      <Container>
        <div className="flex flex-col w-full lg:flex-row gap-8 lg:gap-16 items-center">
          ...
          >
            <div className="space-y-3 md:space-y-4 max-w-[906px] mx-auto">
              <h2
                id="ready-section-title"
                className="font-inter text-[27px] max-w-[906px] text-center sm:text-[32px] md:text-[36px] leading-[1.2] md:leading-[74px] font-semibold text-[#101828]"
              >
                Don’t be left behind. Start reconciling smarter today
              </h2>
              <p className="font-inter text-base max-w-[906px] text-center sm:text-lg md:text-[20px] leading-[1.5] md:leading-[30px] text-[#475467]">
