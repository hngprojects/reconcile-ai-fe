      ...
      >
        ...
        <div className="px-4 md:px-6 py-8 md:py-[76px] flex flex-col items-center justify-center gap-6">
          <div className="flex flex-col items-center gap-4">
            ...
            <h3 className="font-inter font-semibold text-[28px] leading-[120%] text-[#141414]">
              Welcome Back!
            </h3>
            <p className="font-openSans text-[14px] leading-[140%] text-[#475569] text-center max-w-[400px]">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full md:w-[487px] h-[48px] md:h-[64px] rounded-[8px] 
                     border border-[#CBD5E1] flex items-center justify-center gap-[10px] 
                     px-4 py-2 hover:bg-gray-50 transition-colors disabled:opacity-50 cursor-pointer"
          >
