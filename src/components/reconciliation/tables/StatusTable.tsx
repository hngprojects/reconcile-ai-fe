          ...
          <div className="flex flex-col">
            {Array.from({ length: maxItems }).map((_, index) => (
              ...
              >
                <div
                  className={cn(
                    'relative flex items-center justify-center px-1 text-sm font-semibold',
                ...
                >
                  ...
                  {hasPlanAccess('match') && matched && (
                    <button
                      ...
                      className="absolute -top-5 -right-5 z-20 hidden cursor-pointer rounded-full p-1 group-hover:block hover:bg-black/20"
                      onClick={(e) => {
                        e.stopPropagation()
                    ...
                    >
                      <XIcon className="h-4 w-4 text-[#333333]" />
                    </button>
                  )}
                </div>
              </div>
