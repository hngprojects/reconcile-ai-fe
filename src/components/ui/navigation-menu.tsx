...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      <span
        className={cn(
          'group-data-[state=open]:text-primary group-data-[state=open]:after:h-[2px] group-data-[state=open]:after:w-full group-data-[state=open]:after:bg-[#2E604A]',
          className
        )}
      >
        {children}
...
function NavigationMenuViewport({
  ...
  return (
    <div
      className={cn(
        'absolute top-full left-1/2 isolate z-50 flex -translate-x-1/2 transform justify-center'
      )}
    >
