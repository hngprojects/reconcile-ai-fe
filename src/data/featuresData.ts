export const featuresData = [
  ...
  // {
  //   id: 2,
  //   title: "Risk-free Exploration with Limited Trial Access",
  //   content:
  //     "Users can explore ReconXi’s powerful reconciliation features with a limited trial. Test out available features without commitment, giving you a risk-free opportunity to explore the platform’s potential before making a decision.",
  // },
  {
    id: 3,
  ...
  //   id: 5,
  //   title:
  //     "Find and Match Unmatched Records by Date and Amount with Limited Trial Access",
  //   content:
  //     "Make your reconciliation process easy by searching and matching unmatched records. ReconXi allows you to filter records by date and amount range, providing you with the flexibility to quickly identify discrepancies and ensure accuracy in your financial data.",
  // },
  {
    id: 5,
